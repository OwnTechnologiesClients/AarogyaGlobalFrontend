  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-12">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-800 mb-4">Certificate Swiper Showcase</h1>
        <p className="text-lg text-gray-600">
          Demonstrating different variants and configurations of the CertificateSwiper component
        </p>
      </div>

      {/* Default Variant */}
      <section className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        <h2 className="text-2xl font-bold text-gray-800 mb-6">Default Variant</h2>
        <p className="text-gray-600 mb-6">
          Best for detailed pages like Hospital Features. Includes larger cards with full descriptions.
        </p>
        <CertificateSwiper 
          variant="default"
      ...
      {/* Minimal Variant */}
      <section className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        <h2 className="text-2xl font-bold text-gray-800 mb-6">Minimal Variant</h2>
        <p className="text-gray-600 mb-6">
      ...
      {/* Compact Variant */}
      <section className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        <h2 className="text-2xl font-bold text-gray-800 mb-6">Compact Variant</h2>
        <p className="text-gray-600 mb-6">
          Ideal for sidebars, footers, or space-constrained areas. Smaller cards with essential info.
        </p>
        <CertificateSwiper 
          variant="compact"
      ...
      {/* Custom Certificates */}
      <section className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        <h2 className="text-2xl font-bold text-gray-800 mb-6">Custom Certificates</h2>
        <p className="text-gray-600 mb-6">
      ...
      <section className="bg-gray-50 rounded-2xl p-8">
        ...
        <p className="text-gray-600 mb-6">
          Certificate swiper without title, useful when embedded in other sections.
        </p>
        <CertificateSwiper 
          variant="minimal"
          showTitle={false}
      ...
      <section className="bg-blue-50 rounded-2xl p-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-white rounded-xl p-6">
            <h3 className="font-bold text-gray-800 mb-3">Hospital Overview Page</h3>
...
/>`}
          ...
          <div className="bg-white rounded-xl p-6">
            <h3 className="font-bold text-gray-800 mb-3">Hospital Features Page</h3>
            <code className="text-sm bg-gray-100 p-3 rounded block">
              {`<CertificateSwiper 
  variant="default"
