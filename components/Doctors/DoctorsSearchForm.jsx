      ...
      <div className="gap-3 sm:gap-4 p-3 sm:p-4 md:p-6 bg-white rounded-lg border border-black-100 shadow-md mx-2 sm:mx-4 md:mx-8 lg:mx-10 my-3 sm:my-4 md:my-5">
        ...
        <div className="flex flex-col sm:flex-row justify-center sm:justify-end gap-3">
          <button
            ...
            className="w-full sm:w-auto text-blue-600 hover:text-blue-800 font-medium px-4 py-2 rounded-lg transition-colors duration-200 border border-blue-600 hover:bg-blue-50"
          >
            Reset Filters
          </button>
          <button
