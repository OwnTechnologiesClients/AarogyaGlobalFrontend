...
const DoctorVideoSection = () => {
  ...
  return (
    <>
      ...
      <div
        onClick={openModal}
        className="relative 2xl:w-[700px] 2xl:h-[600px] md:h-[550px] md:w-[550px] sm:h-[400px] sm:w-[400px] h-[250px] w-[250px]   rounded-2xl overflow-hidden shadow-lg cursor-pointer"
      >
        <Image
