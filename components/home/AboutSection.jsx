      ...
      <div className="w-full px-4 md:px-12 lg:px-20 flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="flex-1 flex flex-col gap-6 items-center md:items-start">
          ...
          <div className="flex items-center bg-white rounded-2xl shadow-md p-4 gap-4 w-full max-w-xs">
            <Image
              src={aboutData.doctors[0].image}
              alt={aboutData.doctors[0].name}
              width={56}
              height={56}
            ...
            <div className="flex-1">
              <div className="font-bold text-lg text-gray-900">
                {aboutData.doctors[0].name}
              </div>
              <div className="text-gray-500 text-sm">
                {aboutData.doctors[0].specialty}
              </div>
            </div>
            <button className="bg-[#6C2BFF] text-white px-4 py-2 rounded-lg font-semibold text-sm">
              Book Now
            </button>
          </div>
          {/* Group Image */}
          ...
          <div className="flex items-center bg-white rounded-2xl shadow-md p-4 gap-4 w-full max-w-xs">
            <Image
              src={aboutData.doctors[1].image}
              alt={aboutData.doctors[1].name}
              width={56}
              height={56}
              className="rounded-full object-cover border-2 border-green-400"
            />
            <div className="flex-1">
              <div className="font-bold text-lg text-gray-900">
                {aboutData.doctors[1].name}
              </div>
              <div className="text-gray-500 text-sm">
                {aboutData.doctors[1].specialty}
              </div>
            </div>
            <button className="bg-[#6C2BFF] text-white px-4 py-2 rounded-lg font-semibold text-sm">
              Book Now
        ...
        <div className="flex-1 flex flex-col gap-6 items-start">
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 w-full mt-4">
            <Link
              ...
              className="bg-[#6C2BFF] text-white px-6 py-3 rounded-xl font-semibold text-base flex items-center gap-2 shadow-md hover:bg-[#4b1bb3] transition"
            >
