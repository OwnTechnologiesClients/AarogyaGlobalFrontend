...
const Testimonials = () => (
  <div className="flex flex-col items-center md:mb-8 md:mt-8 mb-4 mt-4 gap-8">
    <WelcomeBanner
      text="TESTIMONIALS"
      textColor="#04CE78"
      dotColor="#04CE78"
      ...
      className="text-xl"
    />
    <p className="md:text-4xl text-2xl text-blue-950 font-semibold text-center">
    ...
    <div className="flex flex-col md:flex-row gap-6 w-full items-center justify-center">
      ...
      {/* Testimonial Card 1 */}
      <div className="w-full max-w-2xl border border-black rounded-3xl p-6 md:p-4 shadow-md flex flex-col md:flex-row gap-6 bg-white">
        <img
          src="https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=400"
          alt="Steven Borders"
          className="w-full md:w-60 h-60 rounded-xl object-cover"
        />
        <div className="flex flex-col justify-between flex-1 relative">
          <div>
            ...
            <p className="text-gray-600 leading-relaxed">
              “Our administrative and clinical team is second pledge to help all
              and give hope to those who have in this endeavor while we have the
              best taking care of the patients.”
            </p>
          </div>
      ...
      {/* Testimonial Card 2 — same structure */}
      <div className="w-full max-w-2xl border border-black rounded-3xl p-6 md:p-4 shadow-md flex flex-col md:flex-row gap-6 bg-white">
        <img
          src="https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=400"
          alt="Steven Borders"
      ...
      {/* Testimonial Card 3 — same structure */}
      <div className="w-full max-w-2xl border border-black rounded-3xl p-6 md:p-4 shadow-md flex flex-col md:flex-row gap-6 bg-white">
        <img
          src="https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=400"
          alt="Steven Borders"
