...
const HospitalLocation = () => {
  ...
  const operatingHours = [
    { day: "Monday - Friday", hours: "24/7 Emergency, 8:00 AM - 8:00 PM General" },
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      {/* Header */}
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-gray-800 mb-4">Location & Contact</h2>
        <p className="text-gray-600 text-lg">
          Find us easily with detailed location information and multiple transportation options.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="h-80 bg-gray-200 relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center">
                <MapPin className="w-16 h-16 text-[#04CE78] mx-auto mb-4" />
                <p className="text-gray-600 font-medium">Interactive Map</p>
                <p className="text-gray-500 text-sm">Click to open in Google Maps</p>
              </div>
            </div>
            
            {/* Map Controls */}
            <div className="absolute top-4 right-4 space-y-2">
              <button className="bg-white shadow-md rounded-lg p-2 hover:bg-gray-50 transition-colors">
          ...
          <div className="p-6">
            <h3 className="font-bold text-gray-800 mb-2">{hospitalInfo.name}</h3>
      ...
      {/* Nearby Landmarks */}
      <div className="mt-12">
        <h3 className="text-2xl font-bold text-gray-800 mb-6">Nearby Landmarks</h3>
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {nearbyLandmarks.map((landmark, index) => (
              <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                ...
                <span className="text-[#04CE78] font-medium text-sm">{landmark.distance}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="mt-12 bg-gradient-to-r from-red-600 to-red-800 rounded-2xl p-8 text-white">
        <div className="text-center">
          ...
          <p className="text-red-100 mb-6">Our emergency department is open 24/7 for urgent medical care</p>
