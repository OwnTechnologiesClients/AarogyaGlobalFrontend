...
function initializeEmailJsIfNeeded() {
	...
	const publicKey = "oFPF9MhFZzzjyp2vO";
...
export async function sendContactEmail(
	...
	const serviceId = "service_jqaawfc";
	const templateId = "template_tyydd0d"; // universal template
	const params = {
		name: name || "",
		email: email || "",
		phone: phone || "",
...
export async function sendPartnerEmail(
	...
	const serviceId = "service_jqaawfc";
	const templateId = "template_su9uayi"; // partner template
	const params = {
