...
class DataService {
  constructor() {
    ...
    // Map of treatment IDs to images stored in public/Treatment Photos
    this.treatmentImageMap = {
      // Orthopedics
      "ORT0001": "/Treatment Photos/ORT0001 -TKR - Total Knee Replacement.png",
      "ORT0002": "/Treatment Photos/ORT0002 - Hip Replacement.png",
      "ORT0003": "/Treatment Photos/ORT0003 - ACL.png",
      "ORT0004": "/Treatment Photos/ORT0004- Shoulder.png",
      // Cardiology
      "CARD0001": "/Treatment Photos/CARD0001 - CABG.png",
      "CAR0002": "/Treatment Photos/CAR0002.png",
      "CAR0003": "/Treatment Photos/CAR0003-SAVR TVR.png",
      "CAR0004": "/Treatment Photos/CAR0004-Pacemaker.png",
      "CAR0005": "/Treatment Photos/CAR0005-Catheter Ablation.png",
      // Neurology
      "NEUR0001": "/Treatment Photos/NEUR0001-IV Thrombolysis.png",
      // Oncology
      "ONC0001": "/Treatment Photos/ONC0001-Immune Checkpoint Inhibitors.png",
      "ONC0002": "/Treatment Photos/ONC0002-Mastectomy.png",
      "ONC0003": "/Treatment Photos/ONC0003-Radical Prostatectomy.png",
      "ONC0005": "/Treatment Photos/ONC0005 - Debulking (Cytoreductive) Surgery.png",
      "ONC0006": "/Treatment Photos/ONC0006-Alkylating agents.png",
      "ONC0007": "/Treatment Photos/ONC0007-Anthacyclines.png",
      "ONC0008": "/Treatment Photos/ONC0008-Platinum Compounds.png",
      "ONC0009": "/Treatment Photos/ONC0009.png",
      "ONC0010": "/Treatment Photos/ONC0010.png",
      "ONC0011": "/Treatment Photos/ONC0011-CAR-T.png",
      "ONC0012": "/Treatment Photos/ONC0012=Oncolytic Viruses.png",
      "ONC0013": "/Treatment Photos/ONC0013.png"
    };
  ...
  */
  ...
  async getHospitalById(hospitalId) {
    try {
      ...
      try {
        const testResponse = await fetch(`${this.apiService.baseURL}/hospitals/list?limit=1`);
        if (process.env.NODE_ENV === 'development') {
          console.log(`getHospitalById: API connectivity test - Status: ${testResponse.status}`);
        }
      } catch (testError) {
        if (process.env.NODE_ENV === 'development') {
  ...
  */
  ...
  async getTreatmentById(treatmentId) {
    try {
      ...
      if (response.success && response.data) {
        console.log(`getTreatmentById: Found treatment: ${response.data.name}`);
        return {
          treatment: response.data,
          specialty: {
            name: response.data.category || 'Medical Treatment',
            slug: response.data.category?.toLowerCase().replace(/\s+/g, '-') || 'treatment',
          ...
          packages: [
            {
              ...
              image: this.treatmentImageMap[treatment.id] || "/hospitaldirectory/img1.png"
            }
          ]
        },
