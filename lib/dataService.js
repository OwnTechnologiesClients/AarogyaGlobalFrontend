  ...
  getIndividualTreatmentData(treatmentId) {
    ...
    const individualTreatmentData = {
      treatment: {
        ...
        advancedTreatments: treatment.advancedTreatmentOptions ? treatment.advancedTreatmentOptions.split('; ') : [
        ...
        advantages: treatment.advantages ? treatment.advantages.split('; ') : [
        ...
        faq: treatment.faq ? treatment.faq : [
          "How long do implants last? Often >20–25 yrs.",
          "When can I drive? Typically 4–6 weeks if safe.",
          "Are both knees done together? Sometimes; depends on risk profile."
        ]
      }
    };
