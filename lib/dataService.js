...
class DataService {
  ...
  getTreatmentById(treatmentId) {
    ...
    for (const specialty of Object.values(this.data.specialties)) {
      ...
      const treatment = specialty.treatments?.find(t => t.id === parseInt(treatmentId));
      if (treatment) {
    ...
    const individualTreatmentData = {
      treatment: {
        ...
        bestHospitals: {
          ...
          description: `What helps to find the best hospital for ${treatment.name}?`,
          hospitals: this.getHospitalsBySpecialty(specialty.slug) || [],
          selectionCriteria: [
        ...
        topDoctors: {
          ...
          description: `How to select the best doctor for ${treatment.name}?`,
        ...
        costs: {
          title: `${treatment.name} cost worldwide`,
          treatments: [
            {
              name: treatment.name,
        ...
        diagnosticTools: {
          title: `Diagnostic tools for ${treatment.name}`,
          conventionalMethods: {
            title: "Conventional Diagnostic Methods",
            primary: {
              name: "Physical Examination",
        ...
        advancedTreatments: {
          title: `Advanced treatment options for ${treatment.name}`,
          latestOptions: {
            title: "Latest Treatment Options",
            primary: {
              name: "Minimally Invasive Procedures",
        ...
        advantages: {
          title: `Advantages of ${treatment.name}`,
          benefits: {
            title: "Treatment Benefits",
            primary: {
              name: "High Success Rate",
          ...
          questions: [
            {
              ...
              answer: `${treatment.name} is a medical procedure that ${treatment.description.toLowerCase()}. It is performed by experienced specialists using advanced medical technology.`
            },
            {
              question: `How long does ${treatment.name} take?`,
              answer: `The procedure typically takes ${treatment.duration}. Recovery time is usually ${treatment.recovery}.`
            },
            {
              question: `What is the cost of ${treatment.name}?`,
              answer: `The cost of ${treatment.name} is ${treatment.price}. This includes all necessary medical care and support services.`
            },
            {
              question: `What are the risks of ${treatment.name}?`,
              answer: `As with any medical procedure, there are some risks involved. Your doctor will discuss all potential risks and benefits before the treatment.`
            },
            {
              question: `How do I prepare for ${treatment.name}?`,
              answer: `Preparation typically involves medical evaluation, blood tests, and following specific dietary and medication guidelines provided by your doctor.`
            }
          ]
        }
      }
