  ...
  getIndividualTreatmentData(treatmentId) {
    ...
    const individualTreatmentData = {
      treatment: {
        ...
        topDoctors: {
          title: treatment.topDoctors?.title || `Top doctors for ${treatment.name}`,
          description: treatment.topDoctors?.description || treatment.doctorSelectionCriteria || `How to select the best doctor for ${treatment.name}?`,
          doctors: treatment.topDoctors?.doctors || this.getDoctorsBySpecialty(specialty.slug) || [],
          selectionCriteria: treatment.topDoctors?.selectionCriteria || treatment.doctorSelectionList || [
